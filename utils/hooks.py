...
def create_hook_fns_analyze(checkpoint_grad_step):
    hook_fns_frequencies = [
        ...
        (0, utils.plot.hook_plot_weights_vs_correlations),
        (0,utils.plot.hook_plot_pc_proj_onto_template),
        (0,utils.plot.hook_plot_proj_readout_onto_template),
...
def create_hook_fns_train(start_grad_step,
    ...
    hook_fns_frequencies = [
        ...
        #(plot_freq,utils.plot.hook_plot_pc_proj_onto_template),
